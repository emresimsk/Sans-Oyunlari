...
class SansTopu extends Component {
    constructor(){
        super();
    ...
    handleGetSayisalLotoResult = (date) => {
        ...
        let url = "http://localhost:60897/api/loto/GetSansTopuResult/"+date;
    ...
    handleGetSayisalLotoDates = () => {
        ...
        let url = "http://localhost:60897/api/loto/GetSansTopuDates";
        fetch(url).then(res => res.json())
        .then((response)=>{
    ...
    render = () => {
        const {sanstopu,dates,loading,error} = this.state;

        if(error){
            return(
                <div className="jumbotron jumbotron-fluid">
                    <div className="container">
                    <h1 className="display-4">Şans Topu Çekiliş Sonuçları</h1>
                    <hr className="my-4"/>
                    <div className="lead">
        ...
        const winNumberArray = sanstopu.data.rakamlarNumaraSirasi.split(' - ');
        ...
        return (
            ...
            <div className="container">
              ...
              <div className="lead">
                  <div className="row">
                    <div className="col-sm-6">
                        ...
                        <div className="form-group row">
                            <label htmlFor="staticEmail" className="col-sm-4 font-weight-normal">Hafta</label>
                            <div className="col-sm-8">
                                <p className="col-form-label">{sanstopu.data.hafta}</p>
                            </div>
                        </div>
                    </div>
                  </div>
                  ...
                  <div className="row">
                      {
                        sanstopu.data.buyukIkrKazananIlIlceler.map((item,index)=>
                  ...
                  <div className="row">
                     {
                        sanstopu.data.bilenKisiler.map((item,index)=>
