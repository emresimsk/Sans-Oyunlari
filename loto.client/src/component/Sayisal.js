...
class Sayisal extends Component {
    constructor(){
        super();
    ...
    handleGetSayisalLotoResult = (date) => {
        ...
        let url = "http://localhost:60897/api/loto/GetSayisalLotoResult/"+date;
    ...
    handleGetSayisalLotoDates = () => {
        ...
        let url = "http://localhost:60897/api/loto/GetSayisalLotoDates";
        fetch(url).then(res => res.json())
        .then((response)=>{
